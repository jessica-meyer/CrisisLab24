...
#constants
THRESHOLD = 4 #CHANGE TO THRESHOLD ON DAY
AIRPRES = 101300
    ...
    while True:
        if serialInst.in_waiting:
            ...
            try:
                ...
                if height >= (THRESHOLD): #initial_height + 
                    thresholdMet = True
...
@app.route('/data')
def data():
    #dynamic_threshold = THRESHOLD + (initial_height if initial_height is not None else 0)
    return jsonify({
